...
namespace SSMP.Core.DataInterfaces
{
    ...
    /// </summary>
    public interface IUserStatusDao : IDao<UserStatus, System.Int32>
    {
        SearchResult<UserStatus> GetUserStatusListByParam(UserStatus entity, SearchParam searchParam);
    }
}
