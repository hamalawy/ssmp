...
namespace SSMP.Core.DataInterfaces
{
    ...
    /// </summary>
    public interface IActionDetailDao : IDao<ActionDetail, ActionDetail.DomainObjectID>
    {
        SearchResult<ActionDetail> GetActionDetailListByParam(ActionDetail entity, SearchParam searchParam);
    }
}
